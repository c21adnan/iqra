      ...
      <header className="border-b border-black/10 bg-[#f7f7f2]/90 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold tracking-tight">BREU</p>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-black/60">
            Build your site, sell knowledge, grow a membership, and understand what is working without stitching together a dozen tools.
          </p>
          <div className="mt-9 flex flex-wrap gap-3">
            <button className="rounded-xl bg-[#173f35] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#173f35]/15">
              Create your workspace
            </button>
            <button className="rounded-xl border border-black/15 bg-white px-5 py-3 text-sm font-semibold">
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {modules.map(([title, body], index) => (
            <article key={title} className="group rounded-2xl border border-black/10 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:shadow-xl">
