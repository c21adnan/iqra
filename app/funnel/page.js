  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-12">
      ...
      <section className="mt-10 grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
        <div>
          <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#b15e35]">Sales funnel and email</p>
      ...
      <section className="mt-10 rounded-[2rem] border border-black/10 bg-white p-6">
        <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.18em] text-[#b15e35]">Email sequence preview</p>
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          {welcomeSequence.map((email) => (
            <article key={email.subject} className="rounded-2xl bg-[#f7f7f2] p-5">
              <p className="text-xs font-semibold uppercase tracking-[0.16em] text-[#b15e35]">{email.timing}</p>
